...
public class FraudDetectorService {
    ...
    private static Properties properties() {
        ...
        //gera um CONSUMER_ID diferente a cada vez que roda esse .java
        properties.setProperty(ConsumerConfig.CLIENT_ID_CONFIG, FraudDetectorService.class.getSimpleName() + "-" + UUID.randomUUID());
        //qnd recebe a mensagem ele já avisa que já consumiu ela, não deixa acumular. Máximo de records que vai consumir por vez é 1
